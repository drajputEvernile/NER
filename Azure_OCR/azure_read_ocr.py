...
def get_settings() -> Settings:
    ...
    return Settings(
        azure_document_intelligence_endpoint=env.get("AZURE_DOCUMENT_INTELLIGENCE_ENDPOINT"),
        azure_document_intelligence_key=env.get("AZURE_DOCUMENT_INTELLIGENCE_KEY"),
        azure_poll_timeout_seconds=int(env.get("AZURE_POLL_TIMEOUT_SECONDS") or 180),
    )
